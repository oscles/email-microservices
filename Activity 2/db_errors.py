ERRORS_LIST = [
    {
        'code': 1020,
        'type': 'LAN Connection Error	LAN communication failure.',
    ...
    {
        'code': 1022,
        'type': 'Failure to open USB',
        'body': 'Reinsert the USB cable.'
    },
    {
        'code': 1028,
        'type': 'Reception Timeout Error',
